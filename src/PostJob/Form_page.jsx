  ...
  return (
    <>
      <div className="space-y-1 relative">
        <div className="md:divide-y-2 mb-4 mx-8 ">
      ...
      <div className="mb-28 bg-gradient-to-br  from-indigo-200 to-pink-100 via-blue-100 ">
        <Footer route="home"/>
...
const Preview=({project,setStepNum})=>{
  return(
    ...
    animate={{opacity:1,x:0 , transition:{
     ...
     className="fixed top-20 rounded-lg right-0 md:w-1/2 overflow-y-scroll  md:h-full z-10 mb-32 bg-purple-200">
    <div className=" mx-8 my-12 md:p-8  md:*:p-4">
    <div className="grid grid-cols-6 md:grid-cols-5 ">
      <p  className="font-semibold  md:col-span-1">Project Title:</p>
