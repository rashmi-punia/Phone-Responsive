  ...
  return (
    <>
      ...
      <div className=" flex  md:space-x-10">
        <div className="w-1/3 hidden md:flex sticky left-0 bottom-0 top-0 h-full overflow-hidden justify-center items-center">
          ...
          {/* <Category /> */}
          <div className="flex  justify-center  md:w-1/2 m-4 w-full h-full">
{ 
