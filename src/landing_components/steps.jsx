  ...
  return (
    <>
      <div className=" px-7 text-sky-950  ">
        <div className=" font-riot md:text-3xl text-2xl text-center">
          <h1>
            O G T, where finding Developers is a
            <span className="text-blue-500"> real Breeze</span>
          </h1>
        </div>
        <motion.div variants={variants} initial="initial" whileInView="animate"  className="md:grid md:grid-cols-4 mt-10 *:bg-white md:*:m-2 *:my-4 *:rounded-3xl">
          <motion.div variants={variants} whileHover={{ y:-5 }} className="p-4 md:p-8 items-center flex flex-col">
            <FaUserCheck className="md:m-2 text-5xl md:text-6xl" />
          ...
          <motion.div variants={variants} whileHover={{ y:-5 }} className="p-4 md:p-8 items-center flex flex-col">
            <BiImport className="md:m-2 text-5xl md:text-6xl" />
          ...
          <motion.div variants={variants} whileHover={{ y:-5 }} className="p-4 md:p-8 items-center flex flex-col">
            <SiBookstack className="md:m-2 text-5xl md:text-6xl" />
          ...
          <motion.div variants={variants} whileHover={{ y:-5 }} className="p-4 md:p-8 items-center flex flex-col">
            <RiChatCheckFill className="md:m-2 text-5xl md:text-6xl" />
