...
const LandingPage = () => {
  const { isScrolled,setStepCount,stepCount } = useContext(GlobalContext);
  ...
  return (
    <>
      <motion.div
        ...
        className="bg-gradient-to-l from-pink-300 via-orange-200 to-blue-200  font-fontBody text-sm md:text-lg "
      >
